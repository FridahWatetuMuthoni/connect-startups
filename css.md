# Project CSS Code Reference

## Favicon Attribution

<a href="https://www.flaticon.com/free-icons/favicon" title="favicon icons">Favicon icons created by Flat Icons - Flaticon</a>
...
## Adding Custom Classes when Using Tailwind css
...
@layer utilities {
  .heading {
    @apply uppercase bg-black px-6 py-3 font-work-sans font-extrabold text-white sm:text-[54px] leading-[46px] max-w-5xl text-center;
  }
}
```
